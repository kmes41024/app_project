...
public class Cloud_ComputingFragment extends Fragment {

    private Cloud_ComputingViewModel cloud_computingViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        cloud_computingViewModel =
                ViewModelProviders.of(this).get(Cloud_ComputingViewModel.class);
        View root = inflater.inflate(R.layout.fragment_cloud_computing, container, false);
        ...
        PostExisted posts = new PostExisted(title, start, end, place, sub, noti, Final, c1, c2, c3, link, icon, "Cloud Computing");
        mData = posts.getself();
