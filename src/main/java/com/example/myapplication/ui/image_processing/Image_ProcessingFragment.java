...
public class Image_ProcessingFragment extends Fragment {

    private Image_ProcessingViewModel  image_processingViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        image_processingViewModel =
                ViewModelProviders.of(this).get(Image_ProcessingViewModel.class);
        View root = inflater.inflate(R.layout.fragment_image_processing, container, false);
        ...
        PostExisted posts = new PostExisted(title, start, end, place, sub, noti, Final, c1, c2, c3, link, icon, "Image Processing");
        mData = posts.getself();
