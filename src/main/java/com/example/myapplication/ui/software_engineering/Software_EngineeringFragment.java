...
public class Software_EngineeringFragment extends Fragment {

    private Software_EngineeringViewModel  software_engineeringViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        software_engineeringViewModel =
                ViewModelProviders.of(this).get(Software_EngineeringViewModel.class);
        View root = inflater.inflate(R.layout.fragment_soft_engineering, container, false);
        ...
        PostExisted posts = new PostExisted(title, start, end, place, sub, noti, Final, c1, c2, c3, link, icon,"Soft Engineering");
        mData = posts.getself();
