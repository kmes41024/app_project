...
public class Information_TechnologyFragment extends Fragment {

    private Information_TechnologyViewModel  information_technologyViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        information_technologyViewModel =
                ViewModelProviders.of(this).get(Information_TechnologyViewModel.class);
        View root = inflater.inflate(R.layout.fragment_information_technology, container, false);
        ...
        PostExisted posts = new PostExisted(title, start, end, place, sub, noti, Final, c1, c2, c3, link, icon, "Information Technology");
        mData = posts.getself();
