...
public class Computer_ScienceFragment extends Fragment {

    private Computer_ScienceViewModel  computer_scienceViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        computer_scienceViewModel =
                ViewModelProviders.of(this).get(Computer_ScienceViewModel.class);
        View root = inflater.inflate(R.layout.fragment_computer_science, container, false);
        ...
        PostExisted posts = new PostExisted(title, start, end, place, sub, noti, Final, c1, c2, c3, link, icon, "Computer Science");
        mData = posts.getself();
