...
public class Signal_ProcessingFragment extends Fragment {

    private Signal_ProcessingViewModel signal_processingViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        signal_processingViewModel =
                ViewModelProviders.of(this).get(Signal_ProcessingViewModel.class);
        View root = inflater.inflate(R.layout.fragment_signal_processing, container, false);
        ...
        PostExisted posts = new PostExisted(title, start, end, place, sub, noti, Final, c1, c2, c3, link, icon, "Signal Processing");
        mData = posts.getself();
