...
public class Computer_VisionFragment extends Fragment {

    private Computer_VisionViewModel  computer_visionViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        computer_visionViewModel =
                ViewModelProviders.of(this).get(Computer_VisionViewModel.class);
        View root = inflater.inflate(R.layout.fragment_computer_vision, container, false);
        ...
        PostExisted posts = new PostExisted(title, start, end, place, sub, noti, Final, c1, c2, c3, link, icon, "Computer Vision");
        mData = posts.getself();
