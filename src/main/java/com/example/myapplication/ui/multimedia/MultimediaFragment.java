...
public class MultimediaFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        multimediaViewModel =
                ViewModelProviders.of(this).get(MultimediaViewModel.class);
        ...
        PostExisted posts = new PostExisted(title, start, end, place, sub, noti, Final, c1, c2, c3, link, icon, "Multimedia");
        mData = posts.getself();
