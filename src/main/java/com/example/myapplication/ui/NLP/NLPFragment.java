...
public class NLPFragment extends Fragment {
    ...
    private NLPViewModel  nlpViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        nlpViewModel =
                ViewModelProviders.of(this).get(NLPViewModel.class);
        View root = inflater.inflate(R.layout.fragment_nlp, container, false);
        ...
        PostExisted posts = new PostExisted(title, start, end, place, sub, noti, Final, c1, c2, c3, link, icon, "NLP");
        mData = posts.getself();
