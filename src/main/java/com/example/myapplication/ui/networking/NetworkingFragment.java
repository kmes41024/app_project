...
public class NetworkingFragment extends Fragment {
    ...
    private NetworkingViewModel  networkingViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        networkingViewModel =
                ViewModelProviders.of(this).get(NetworkingViewModel.class);
        ...
        PostExisted posts = new PostExisted(title, start, end, place, sub, noti, Final, c1, c2, c3, link, icon, "Networking");
        mData = posts.getself();
