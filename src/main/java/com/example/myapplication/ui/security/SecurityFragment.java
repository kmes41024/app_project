...
public class SecurityFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        securityViewModel =
                ViewModelProviders.of(this).get(SecurityViewModel.class);
        ...
        PostExisted posts = new PostExisted(title, start, end, place, sub, noti, Final, c1, c2, c3, link, icon, "Security");
        mData = posts.getself();
