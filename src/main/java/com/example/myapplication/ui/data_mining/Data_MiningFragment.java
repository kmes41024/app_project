...
public class Data_MiningFragment extends Fragment {

    private Data_MiningViewModel  data_miningViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        data_miningViewModel =
                ViewModelProviders.of(this).get(Data_MiningViewModel.class);
        View root = inflater.inflate(R.layout.fragment_data_mining, container, false);
        ...
        PostExisted posts = new PostExisted(title, start, end, place, sub, noti, Final, c1, c2, c3, icon, link, "Data Mining");
        mData = posts.getself();
