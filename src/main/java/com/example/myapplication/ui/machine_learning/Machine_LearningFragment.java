...
public class Machine_LearningFragment extends Fragment {

    private Machine_LearningViewModel  machine_learningViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        machine_learningViewModel =
                ViewModelProviders.of(this).get(Machine_LearningViewModel.class);
        View root = inflater.inflate(R.layout.fragment_machine_learning, container, false);
        ...
        PostExisted posts = new PostExisted(title, start, end, place, sub, noti, Final, c1, c2, c3, link, icon, "Machine Learning");
        mData = posts.getself();
