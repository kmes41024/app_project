...
public class Big_DataFragment extends Fragment {

    private Big_DataViewModel  big_dataViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        big_dataViewModel =
                ViewModelProviders.of(this).get(Big_DataViewModel.class);
        View root = inflater.inflate(R.layout.fragment_big_data, container, false);
        ...
        PostExisted posts = new PostExisted(title, start, end, place, sub, noti, Final, c1, c2, c3, link, icon, "Big Data");
        mData = posts.getself();
